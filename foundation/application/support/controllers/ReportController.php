<?php
	...
	class Support_reportController extends BaseController {
		private $dbhelper;
		...
		public function reportinfoAction(){
			...
			if($_REQUEST['style'] == "style1"){
				...
				if($start != "" && $end != "" || $pname != ""){
					...
					$selectSQL .= ' and i.pm_name IN (select pname from pm_mg_chouzi where department= ' .$this->admininfo['department_id'] .')';
		...
		public function _init(){
			...
			$pm_chouzi ->selectLimit .= " AND department=".$this->admininfo['department_id'];
