...
class Management_investmentController extends BaseController
{
    ...
    public function toAddlogAction(){
        ...
        $account_id = HttpUtil::postString("account_id");
        $account_re_datetime = HttpUtil::postString("account_re_datetime");
        $account_receipts = HttpUtil::postString("account_receipts");
        $account_expenses = HttpUtil::postString("account_expenses");
        $account_corpus = HttpUtil::postString("account_corpus");
