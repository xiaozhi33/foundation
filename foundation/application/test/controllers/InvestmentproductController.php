...
class Test_investmentproductController extends BaseController
{
    private $dbhelper;
    ...
    public function indexAction()
    {
        ...
        $productDAO->getPager(array('path'=>'/test/investmentproduct/index'))->assignTo($this->view);
    ...
    public function toAddproductAction(){
        ...
        if(empty($id)) {
            ...
            if ($hasproduct) {
                echo json_encode(array('msg' => "该投资账户已添加，请核对后重新添加！！！！！！", 'return_url' => '/test/investmentproduct/'));
                exit;
            }
        }
        ...
        if(empty($id)){
            ...
            echo('<script language="JavaScript">');
            echo("alert('保存成功');");
            echo("location.href='/test/investmentproduct?id=".$investment_id."';");
            echo('</script>');
            exit;
        }else {
            echo('<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />');
            ...
            echo('</script>');
            exit;
            //echo json_encode(array('msg'=>"保存成功！",'return_url'=>'/test/investmentproduct?id=".$investment_id."'));
            //exit;
        }
    }
    ...
    public function delproductAction(){
        ...
        echo('<script language="JavaScript">');
        echo("alert('删除成功');");
        echo("location.href='/test/investmentproduct';");
        echo('</script>');
        exit;
    }
    ...
    public function logAction()
    {
        ...
        $logDAO->getPager(array('path'=>'/test/investmentproduct/log'))->assignTo($this->view);
    ...
    public function toAddlogAction(){
        ...
        if(empty($id)){
            ...
            echo('<script language="JavaScript">');
            echo("alert('保存成功');");
            echo("location.href='/test/investmentproduct/log';");
            echo('</script>');
            exit;
        }else {
            echo('<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />');
            ...
            echo('</script>');
            exit;
            //echo json_encode(array('msg'=>"保存成功！",'return_url'=>'/test/investmentproduct/log'));
            //exit;
        }
    }
