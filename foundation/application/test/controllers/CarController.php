...
class Test_carController extends BaseController
{
    private $dbhelper;
    ...
    public function indexAction()
    {
        ...
        $carDAO->getPager(array('path'=>'/test/car/index'))->assignTo($this->view);
    ...
    public function toAddcarmainAction(){
        ...
        if(empty($id)) {
            ...
            if ($hasCarNumber) {
                echo json_encode(array('msg' => "该车辆信息已添加，请核对后重新添加！！！！！！", 'return_url' => '/test/car/'));
                exit;
            }
        }
        ...
        if(empty($id)){
            ...
            echo('<script language="JavaScript">');
            echo("alert('保存成功');");
            echo("location.href='/test/car';");
            echo('</script>');
            exit;
        }else {
            echo json_encode(array('msg'=>'保存成功！','return_url'=>'/test/car/'));
            exit;
        }
    }
    ...
    public function usecarAction()
    {
        ...
        $carDAO = $carDAO->order('id DESC');
        $carDAO->getPager(array('path'=>'/test/car/usecar'))->assignTo($this->view);
    ...
    public function toAddusecarAction(){
        ...
        if(empty($id)){
            ...
            echo('<script language="JavaScript">');
            echo("alert('保存成功');");
            echo("location.href='/test/car/usecar';");
            echo('</script>');
            exit;
        }else {
            echo json_encode(array('msg'=>"保存成功！",'return_url'=>'/test/car/usecar'));
            exit;
        }
    }
