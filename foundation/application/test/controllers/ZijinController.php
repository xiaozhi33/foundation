<?php
	...
	class Test_zijinController extends BaseController {
		private $dbhelper;
        ...
        public function delzijinAction(){
            ...
            if(!empty($id)){
                ...
                echo "window.location.href='/test/zijin/index'";
                echo "</script>";
                exit();
            }
        }
        ...
        public function claimlistAction()
        {
            ...
            $pageDAO = new pageDAO();
            $pageDAO = $pageDAO->pageHelper($this->renling_weirenling_list, null, "/test/zijin/claimlist", null, 'get', 25, 8);
            $pages = $pageDAO['pageLink']['all'];
            $pages = str_replace("/index.php", "", $pages);
        ...
        public function savebindingclaimAction(){
            try{
                ...
                if($rs){
                    ...
                    $pm_mg_infoDAO ->save();
                    if($rs){
                        alert_go("认领成功！", "/test/zijin/claimlist");
                    }else {
        ...
        public function delClaimAction()
        {
            ...
            echo("alert('删除成功');");
            echo("location.href='/test/zijin/claimlist';");
            echo('</script>');
            exit;
        }
        ...
        public function rateAction()
        {
            ...
            $total = count($signDAO);
            $pageDAO = new pageDAO();
            $pageDAO = $pageDAO->pageHelper($signDAO, null, "/test/zijin/rate", null, 'get', 25, 8);
            $pages = $pageDAO['pageLink']['all'];
            $pages = str_replace("/index.php", "", $pages);
        ...
        public function rate_bakAction()
        {
            ...
            $pageDAO = new pageDAO();
            $pageDAO = $pageDAO->pageHelper($chouziDAO, null, "/test/zijin/rate", null, 'get', 25, 8);
            $pages = $pageDAO['pageLink']['all'];
            $pages = str_replace("/index.php", "", $pages);
        ...
        public function editrsrateAction(){
            ...
            if(!empty($pm_id)){
                ...
                $pm_rateDAO ->last_modify = time();
                $pm_rateDAO ->save();
                //alert_go("编辑成功","/test/zijin/rate");
                alert_go("编辑成功","/test/chouzi/index");
            }else {
                alert_back("编辑失败");
            }
        }
        ...
        public function newsavesignAction()
        {
            ...
            if(empty($pm_id)){
                ...
                echo "window.location.href='/test/zijin/newsigninfo?id=".$pm_id."'; ";
                echo "</script>";
                exit();
            }
            ...
            if($_FILES['sign_files']['name']!=""){
                if($_FILES['sign_files']['error'] != 4){
                    ...
                    if($result['error']!=0){
                        ...
                        echo "window.location.href='/test/zijin/signinfo?id=".$pm_id."'; ";
                        echo "</script>";
                        exit();
                    }else{
            ...
            echo "window.location.href='/test/zijin/rate'; ";
            echo "</script>";
            exit();
        }
