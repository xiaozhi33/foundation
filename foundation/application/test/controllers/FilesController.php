<?php
	...
	class Management_filesController extends BaseController
    {
		public function indexAction(){
            ...
            $filesDAO->getPager(array('path'=>'/test/files/index'))->assignTo($this->view);
        ...
        public function toAddAction(){
            ...
            if($_FILES['files']['name']!=""){
                if($_FILES['files']['error'] != 4){
                    ...
                    if($result['error']!=0){
                        ...
                        echo "window.location.href='/test/files';";
                        echo "</script>";
                        exit();
                    }else{
            ...
            echo "</script>";
            exit();
            //alert_go('保存成功', "/test/files/index");
        }
