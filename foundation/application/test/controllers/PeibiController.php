<?php
	...
	class Test_peibiController extends BaseController
    {
		public function indexAction(){
          ...
          ");
            ...
            $pm_mg_info->getPager(array('path'=>'/test/peibi/index'))->assignTo($this->view);
        ...
        public function peibiindexAction(){
            ...
            $peibikDAO->getPager(array('path'=>'/test/peibi/index'))->assignTo($this->view);
        ...
        public function toAddAction(){
           ...
           /* $pm_id = HttpUtil::postString("pm_id");
            ...
            alert_go('保存成功', "/test/peibi/peibiindex?lk_main_id=".$lk_main_id);
        }
