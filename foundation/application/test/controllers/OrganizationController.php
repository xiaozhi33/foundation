...
class Test_organizationController extends BaseController
{
    private $dbhelper;
    ...
    public function indexAction()
    {
        ...
        $organizationDAO->getPager(array('path'=>'/test/organization/index'))->assignTo($this->view);
    ...
    public function toAddorganizationmainAction(){
        ...
        if(empty($id)){
            ...
            echo('<script language="JavaScript">');
            echo("alert('保存成功');");
            echo("location.href='/test/organization/index?director_id=".$director."&type=".$organization_type."';");
            echo('</script>');
            exit;
        }else {
            echo('<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />');
            ...
            echo('</script>');
            exit;
            //echo json_encode(array('msg'=>"保存成功！",'return_url'=>'/test/organization/?'.$this->org_type_status));
            //exit;
        }
    }
    ...
    public function delorganizationAction(){
        ...
        if($organization1DAO[0]['director'] ){
            echo("location.href='/test/organization/index?director_id=".$organization1DAO[0]['director']."'");
        }else{
            echo("location.href='/test/organization?type=".$organization1DAO[0]['organization_type']."'");
        }
        echo('</script>');
        exit;
    ...
    public function addrsdirectorAction(){
        try{
            if($_REQUEST['director'] != "" ){
                ...
                $pid = $directorinfo->save();
                alert_go("添加成功！", "/test/organization/director");
            }else {
                alert_back("添加失败！");
            }
        }catch (Exception $e){
    ...
    public function editrsdirectorAction(){
        if($_REQUEST['director'] != "" && $_REQUEST['id']){
            ...
            $directorinfo ->end_datetime = $_REQUEST['end_datetime'];
            $directorinfo->save();
            alert_go("编辑成功。","/test/organization/director");
        }else {
            alert_back("添加失败");
        }
    }
    ...
    public function deldirectorAction(){
        if($_REQUEST['id'] != ""){
            ...
            echo('<script language="JavaScript">');
            echo("alert('删除成功');");
            echo("location.href='/test/organization/director';");
            echo('</script>');
            exit;
        }else {
            echo('<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />');
