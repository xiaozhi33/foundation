...
class Test_investmentController extends BaseController
{
    private $dbhelper;
    ...
    public function indexAction()
    {
        ...
        $accountDAO->getPager(array('path'=>'/test/investment/index'))->assignTo($this->view);
    ...
    public function toAddaccountAction(){
        ...
        if(empty($id)) {
            ...
            if ($hasAccount) {
                echo json_encode(array('msg' => "该投资账户已添加，请核对后重新添加！！！！！！", 'return_url' => '/test/investment/'));
                exit;
            }
        }
        ...
        if(empty($id)){
            ...
            echo('<script language="JavaScript">');
            echo("alert('保存成功');");
            echo("location.href='/test/investment';");
            echo('</script>');
            exit;
        }else {
            echo json_encode(array('msg'=>"保存成功！",'return_url'=>'/test/investment/'));
            exit;
        }
    }
    ...
    public function logAction()
    {
        ...
        $logDAO->getPager(array('path'=>'/test/investment/log'))->assignTo($this->view);
    ...
    public function toAddlogAction(){
        ...
        if(empty($id)){
            ...
            echo('<script language="JavaScript">');
            echo("alert('保存成功');");
            echo("location.href='/test/investment/log';");
            echo('</script>');
            exit;
        }else {
            echo json_encode(array('msg'=>"保存成功！",'return_url'=>'/test/investment/log'));
            exit;
        }
    }
