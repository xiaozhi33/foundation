...
class Test_giftController extends BaseController
{
    private $dbhelper;
    ...
    public function indexAction()
    {
        ...
        $giftDAO->getPager(array('path'=>'/test/gift/index'))->assignTo($this->view);
    ...
    public function toAddgiftmainAction(){
        ...
        if(empty($id)) {
            ...
            if ($hasName) {
                echo json_encode(array('msg' => "该礼品信息已添加，请核对后重新添加！！！！！！", 'return_url' => '/test/gift/'));
                exit;
            }
        }
        ...
        if(empty($id)){
            ...
            echo('<script language="JavaScript">');
            echo("alert('保存成功');");
            echo("location.href='/test/gift';");
            echo('</script>');
            exit;
        }else {
            echo json_encode(array('msg'=>"保存成功！",'return_url'=>'/test/gift/'));
            exit;
        }
    }
    ...
    public function usegiftAction()
    {
        ...
        $giftDAO = $giftDAO->order('id DESC');
        $giftDAO->getPager(array('path'=>'/test/gift/usegift'))->assignTo($this->view);
    ...
    public function toAddusegiftAction(){
        ...
        if(empty($id)){
            ...
            echo('<script language="JavaScript">');
            echo("alert('保存成功');");
            echo("location.href='/test/gift/usegift';");
            echo('</script>');
            exit;
        }else {
            echo json_encode(array('msg'=>"保存成功！",'return_url'=>'/test/gift/usegift'));
            exit;
        }
    }
