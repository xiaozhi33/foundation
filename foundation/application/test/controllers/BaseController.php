<?php
    session_start();
	require_once("sessionutil_test.php");
	...
	class BaseController extends Zend_Controller_Action
	{
	    ...
	    {
            ORM::setConfig(__DEFAULTTESTDNS__, __DEFAULTROOT__, __DEFAULTPASSWD__);
	    	$request_mod = $this->getRequest()->getParams();
			$this->view = new Zend_View();
			$this->view ->addScriptPath('application/test/views/scripts');
            $this->orm = ORM::getInstance(__DEFAULTTESTDNS__);
