<?php
	...
	class Test_chouziController extends BaseController
    {
        private $dbhelper;
        ...
        public function indexAction()
        {
            ...
            $pageDAO = new pageDAO();
            $pageDAO = $pageDAO->pageHelper($chouziinfo, null, "/test/chouzi/index", null, 'get', 25, 8);
        ...
        public function pplistAction()
        {
            ...
            $meetingDAO->getPager(array('path' => '/test/chouzi/pplist/'))->assignTo($this->view);
        ...
        public function pminfoAction(){
            ...
            if(!empty($pid)){
                ...
                if(!file_exists(__BASEURL__ ."/include/upload_file/pmqrcode/".$pid.".png")){
                    ...
                    QRcode::png(__BASEURL__ ."/test/chouzi/pminfo?id=".$pid , __UPLOADPICPATH__ . '/pmqrcode/' . $pid .".png", 'H', 5, 2);
                }
