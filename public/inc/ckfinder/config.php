...
function CheckAuthentication()
{
	...
	return isset($_COOKIE['fasttopic_auth']) && $_COOKIE['fasttopic_auth'];
	return false;
}
...
$uploadUrl = '/upload/default/';
if(strpos($_SERVER['HTTP_REFERER'],'/admin/editor/spec-edit')) {
	$uploadUrl = '/upload/special/';
}elseif(strpos($_SERVER['HTTP_REFERER'],'/admin/editor/spec-recommend')) {
	$uploadUrl = '/upload/special/';
}elseif(strpos($_SERVER['HTTP_REFERER'],'/admin/editor/spec-template-edit')) {
	$uploadUrl = '/upload/special/';
}elseif(strpos($_SERVER['HTTP_REFERER'],'/admin/special/edit-tpl')) {
	$uploadUrl = '/upload/template/';
}elseif(strpos($_SERVER['HTTP_REFERER'],'/inc/ckfinder/')) {
	$uploadUrl = '/upload/special/';
}
$baseUrl = $uploadUrl;
...
$config['plugin_imageresize']['smallThumb'] = '120x80';
$config['plugin_imageresize']['mediumThumb'] = '150x100';
$config['plugin_imageresize']['largeThumb'] = '240x160';
